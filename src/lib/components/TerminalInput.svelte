<!--
  TerminalInput — a bordered prompt line with a value and a blinking block cursor,
  for the "waiting for input" state of a Terminal mockup.
-->
<script lang="ts">
	...
	let { value = '', prompt = '>', class: className }: Props = $props();
</script>
